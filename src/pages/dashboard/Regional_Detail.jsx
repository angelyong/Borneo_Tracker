...
const RegionalDetails = () => {
  ...
  useEffect(() => {
    ...
    lineChartInstance.current.setOption({
      ...
      xAxis: {
        type: 'category',
        data: comparisonRows.map((e) => e.territory),
          ...
          {!loading && !error && (
            <>
              ...
              <div style={styles.summaryStrip}>
                {[
                  { label: 'Canonical indicators', value: summary.count },
                  { label: 'Latest year',           value: summary.latestYear || 'Unknown' },
                  { label: 'Trend status',           value: 'Snapshot only' },
                ].map((chip) => (
                  <div key={chip.label} style={styles.summaryChip}>
                    <span style={styles.summaryChipLabel}>{chip.label}</span>
                ...
                <div style={styles.card}>
                  <div style={styles.chartHeader}>
                    <div style={styles.chartHeaderLeft}>
                      ...
                      <div style={{ fontSize: '11.5px', color: '#6b7280' }}>Latest available canonical value for each territory</div>
                    </div>
                ...
                <div style={styles.card}>
                  <div style={styles.chartHeader}>
                    <div style={styles.chartHeaderLeft}>
                      ...
                      <div style={{ fontSize: '13px', color: '#6b7280', marginTop: '4px' }}>Count of canonical indicators available per pillar</div>
                    </div>
                    <div style={styles.chartTabs}>
                ...
                <div style={{ ...styles.card, width: '100%' }}>
                  <div style={styles.chartHeader}>
                    <div style={styles.chartHeaderLeft}>
                      ...
                      <div style={{ fontSize: '13px', color: '#6b7280', marginTop: '4px' }}>Trend charts are held back until the schema stores true yearly series</div>
                    </div>
                    <div style={styles.chartTabs}>
                      <button style={{ ...styles.chartTab, ...styles.chartTabActive }}>Current</button>
                    </div>
                  ...
                  <div style={styles.confidenceSummary}>
                    {Object.entries(confidenceCoverage).map(([label, value]) => (
                      <span key={label} style={styles.confidenceSummaryItem}>{label}: <strong>{value}</strong></span>
                    ))}
                  </div>
